...
namespace Services.Enums
{
    ...
    public sealed partial class DocConstantStudyBias
    {
        ...
        public static implicit operator DocConstantStudyBias(string Val)
        {
            return new DocConstantStudyBias(Val);
        }
        ...
        /// <returns>The result of the conversion.</returns>
        public static implicit operator string(DocConstantStudyBias item)
        {
        ...
        #region IEquatable (DocConstantStudyBias)
        ...
        public bool Equals(DocConstantStudyBias obj)
        {
            return this == obj;
        }
        ...
        public static bool operator ==(DocConstantStudyBias ft1, DocConstantStudyBias ft2)
        {
        ...
        #endregion IEquatable (DocConstantStudyBias)
    }
}