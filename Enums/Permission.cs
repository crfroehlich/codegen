...
namespace Services.Enums
{
    ...
    public sealed partial class DocConstantPermission
    {
        ...
        public static implicit operator DocConstantPermission(string Val)
        {
            return new DocConstantPermission(Val);
        }
        ...
        /// <returns>The result of the conversion.</returns>
        public static implicit operator string(DocConstantPermission item)
        {
        ...
        #region IEquatable (DocConstantPermission)
        ...
        public bool Equals(DocConstantPermission obj)
        {
            return this == obj;
        }
        ...
        public static bool operator ==(DocConstantPermission ft1, DocConstantPermission ft2)
        {
        ...
        #endregion IEquatable (DocConstantPermission)
    }
}
