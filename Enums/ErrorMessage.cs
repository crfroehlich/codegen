...
namespace Services.Enums
{
    ...
    public sealed partial class DocConstantErrorMessage
    {
        ...
        public static implicit operator DocConstantErrorMessage(string Val)
        {
            return new DocConstantErrorMessage(Val);
        }
        ...
        /// <returns>The result of the conversion.</returns>
        public static implicit operator string(DocConstantErrorMessage item)
        {
        ...
        public bool Equals(DocConstantErrorMessage obj)
        {
            return this == obj;
        }
        ...
        public static bool operator ==(DocConstantErrorMessage ft1, DocConstantErrorMessage ft2)
        {
        ...
        #endregion IEquatable (DocConstantErrorMessage)
    }
}