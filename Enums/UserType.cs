...
namespace Services.Enums
{
    ...
    public sealed partial class DocConstantUserType
    {
        ...
        public static implicit operator DocConstantUserType(string Val)
        {
            return new DocConstantUserType(Val);
        }
        ...
        /// <returns>The result of the conversion.</returns>
        public static implicit operator string(DocConstantUserType item)
        {
        ...
        #region IEquatable (DocConstantUserType)
        ...
        public bool Equals(DocConstantUserType obj)
        {
            return this == obj;
        }
        ...
        public static bool operator ==(DocConstantUserType ft1, DocConstantUserType ft2)
        {
        ...
        #endregion IEquatable (DocConstantUserType)
    }
}
