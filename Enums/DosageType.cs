...
namespace Services.Enums
{
    ...
    public sealed partial class DocConstantDosageType
    {
        ...
        public static implicit operator DocConstantDosageType(string Val)
        {
            return new DocConstantDosageType(Val);
        }
        ...
        /// <returns>The result of the conversion.</returns>
        public static implicit operator string(DocConstantDosageType item)
        {
        ...
        public bool Equals(DocConstantDosageType obj)
        {
            return this == obj;
        }
        ...
        public static bool operator ==(DocConstantDosageType ft1, DocConstantDosageType ft2)
        {
        ...
        #endregion IEquatable (DocConstantDosageType)
    }
}
