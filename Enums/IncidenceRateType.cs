...
namespace Services.Enums
{
    ...
    public sealed partial class DocConstantIncidenceRateType
    {
        ...
        public static implicit operator DocConstantIncidenceRateType(string Val)
        {
            return new DocConstantIncidenceRateType(Val);
        }
        ...
        /// <returns>The result of the conversion.</returns>
        public static implicit operator string(DocConstantIncidenceRateType item)
        {
        ...
        #region IEquatable (DocConstantIncidenceRateType)
        ...
        public bool Equals(DocConstantIncidenceRateType obj)
        {
            return this == obj;
        }
        ...
        public static bool operator ==(DocConstantIncidenceRateType ft1, DocConstantIncidenceRateType ft2)
        {
        ...
        #endregion IEquatable (DocConstantIncidenceRateType)
    }
}