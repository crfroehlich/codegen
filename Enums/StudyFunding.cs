...
namespace Services.Enums
{
    ...
    public sealed partial class DocConstantStudyFunding
    {
        ...
        public static implicit operator DocConstantStudyFunding(string Val)
        {
            return new DocConstantStudyFunding(Val);
        }
        ...
        /// <returns>The result of the conversion.</returns>
        public static implicit operator string(DocConstantStudyFunding item)
        {
        ...
        public bool Equals(DocConstantStudyFunding obj)
        {
            return this == obj;
        }
        ...
        public static bool operator ==(DocConstantStudyFunding ft1, DocConstantStudyFunding ft2)
        {
        ...
        #endregion IEquatable (DocConstantStudyFunding)
    }
}
