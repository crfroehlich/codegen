...
namespace Services.Dto
{
    ...
    [Route("/scope/{Id}/lookuptablebinding/version", "GET, POST")]
    [Route("/scope/{Id}/lookuptablebinding", "GET, POST, DELETE")]
    [Route("/scope/{Id}/broadcast/version", "GET, POST")]
    [Route("/scope/{Id}/broadcast", "GET, POST, DELETE")]
    [Route("/scope/{Id}/help/version", "GET, POST")]
    [Route("/scope/{Id}/help", "GET, POST, DELETE")]
    [Route("/scope/{Id}/termsynonym/version", "GET, POST")]
    [Route("/scope/{Id}/termsynonym", "GET, POST, DELETE")]
    [Route("/scope/{Id}/variablerule/version", "GET, POST")]
    [Route("/scope/{Id}/variablerule", "GET, POST, DELETE")]
    [Route("/scope/{Id}/workflow/version", "GET, POST")]
