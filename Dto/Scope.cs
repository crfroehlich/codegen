...
[GeneratedCodeAttribute("T4", "1.0.0.0")]
        ...
        [ApiMember(Name = nameof(BroadcastsIds), Description = "Broadcast Ids", IsRequired = false)]
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public List<int> BroadcastsIds { get; set; }
        [ApiMember(Name = nameof(BroadcastsCount), Description = "Broadcast Count", IsRequired = false)]
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
...
[GeneratedCodeAttribute("T4", "1.0.0.0")]
        ...
        [ApiMember(Name = nameof(ScopedCommentsIds), Description = "Comment Ids", IsRequired = false)]
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        ...
        [ApiMember(Name = nameof(ScopedFilesIds), Description = "File Ids", IsRequired = false)]
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public List<int> ScopedFilesIds { get; set; }
        [ApiMember(Name = nameof(ScopedFilesCount), Description = "File Count", IsRequired = false)]
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        ...
        [ApiMember(Name = nameof(ScopedTagsIds), Description = "Tag Ids", IsRequired = false)]
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
...
[GeneratedCodeAttribute("T4", "1.0.0.0")]
        ...
        [ApiMember(Name = nameof(VariableRulesIds), Description = "VariableRule Ids", IsRequired = false)]
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public List<int> VariableRulesIds { get; set; }
        [ApiMember(Name = nameof(VariableRulesCount), Description = "VariableRule Count", IsRequired = false)]
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
