...
namespace Services.Dto
{
    ...
    [Route("/workflow/{Id}/lookuptablebinding/version", "GET, POST")]
    [Route("/workflow/{Id}/lookuptablebinding", "GET, POST, DELETE")]
    [Route("/workflow/{Id}/workflowcomment/version", "GET, POST")]
    [Route("/workflow/{Id}/workflowcomment", "GET, POST, DELETE")]
    [Route("/workflow/{Id}/document/version", "GET, POST")]
    [Route("/workflow/{Id}/document", "GET, POST, DELETE")]
    [Route("/workflow/{Id}/scope/version", "GET, POST")]
    [Route("/workflow/{Id}/scope", "GET, POST, DELETE")]
    [Route("/workflow/{Id}/tag/version", "GET, POST")]
    [Route("/workflow/{Id}/tag", "GET, POST, DELETE")]
    [Route("/workflow/{Id}/workflowtask/version", "GET, POST")]
    [Route("/workflow/{Id}/workflowtask", "GET, POST, DELETE")]
    [Route("/workflow/{Id}/variableinstance/version", "GET, POST")]
    [Route("/workflow/{Id}/variableinstance", "GET, POST, DELETE")]
    [Route("/workflow/{Id}/workflow/version", "GET, POST")]
