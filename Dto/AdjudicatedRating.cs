...
namespace Services.Dto
{
    ...
    public partial class AdjudicatedRating : AdjudicatedRatingBase, IReturn<AdjudicatedRating>, IDto, ICloneable
    {
        ...
        public new List<string> VisibleFields
        {
            ...
            set
            {
                ...
                _VisibleFields = DocPermissionFactory.SetVisibleFields<AdjudicatedRating>("AdjudicatedRating",exists);
            }
        }
    ...
    public class AdjudicatedRatingFullTextSearch
    {
        ...
        public bool doCreated { get => true == _request.VisibleFields?.Any(v => DocTools.AreEqual(v, nameof(AdjudicatedRating.Created))); }
        public bool doUpdated { get => true == _request.VisibleFields?.Any(v => DocTools.AreEqual(v, nameof(AdjudicatedRating.Updated))); }

        public bool doDocument { get => true == _request.VisibleFields?.Any(v => DocTools.AreEqual(v, nameof(AdjudicatedRating.Document))); }
        public bool doRating { get => true == _request.VisibleFields?.Any(v => DocTools.AreEqual(v, nameof(AdjudicatedRating.Rating))); }
        public bool doReasonRejected { get => true == _request.VisibleFields?.Any(v => DocTools.AreEqual(v, nameof(AdjudicatedRating.ReasonRejected))); }
    }
