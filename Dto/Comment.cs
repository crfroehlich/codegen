...
namespace Services.Dto
{
    public abstract partial class CommentBase : Dto<Comment>
    {
        ...
        public CommentBase(int? pId, Reference pParent, int? pParentId, string pText, Reference pUser, int? pUserId) : this(DocConvert.ToInt(pId)) 
        {
            Parent = pParent;
            ParentId = pParentId;
            Text = pText;
        ...
        public void Deconstruct(out Reference pParent, out int? pParentId, out string pText, out Reference pUser, out int? pUserId)
        {
            pParent = Parent;
            pParentId = ParentId;
            pText = Text;
        ...
        //public CommentBase With(int? pId = Id, Reference pParent = Parent, int? pParentId = ParentId, string pText = Text, Reference pUser = User, int? pUserId = UserId) => 
        //	new CommentBase(pId, pParent, pParentId, pText, pUser, pUserId);
    ...
    public partial class Comment : CommentBase, IReturn<Comment>, IDto, ICloneable
    {
        ...
        public Comment(int? pId, Reference pParent, int? pParentId, string pText, Reference pUser, int? pUserId) : 
            base(pId, pParent, pParentId, pText, pUser, pUserId) { }
        #region Fields
        ...
        [ApiAllowableValues("Includes", Values = new string[] {nameof(Created),nameof(CreatorId),nameof(Gestalt),nameof(Locked),nameof(Parent),nameof(ParentId),nameof(Text),nameof(Updated),nameof(User),nameof(UserId),nameof(VersionNo)})]
