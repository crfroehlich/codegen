...
namespace Services.Dto
{
    ...
    public partial class Characteristic : CharacteristicBase, IReturn<Characteristic>, IDto, ICloneable
    {
        ...
        public new List<string> Select
        {
            ...
            set
            {
                ...
                _Select = DocPermissionFactory.SetSelect<Characteristic>("Characteristic",exists);
            }
        }
    ...
    public class CharacteristicFullTextSearch
    {
        ...
        public bool doCreated { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Characteristic.Created))); }
        public bool doUpdated { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Characteristic.Updated))); }

        public bool doDocumentSets { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Characteristic.DocumentSets))); }
        public bool doName { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Characteristic.Name))); }
        public bool doURI { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Characteristic.URI))); }
    }
