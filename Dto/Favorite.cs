...
namespace Services.Dto
{
    ...
    public partial class Favorite : FavoriteBase, IReturn<Favorite>, IDto, ICloneable
    {
        ...
        public new List<string> VisibleFields
        {
            ...
            set
            {
                ...
                _VisibleFields = DocPermissionFactory.SetVisibleFields<Favorite>("Favorite",exists);
            }
        }
    ...
    public class FavoriteFullTextSearch
    {
        ...
        public bool doCreated { get => true == _request.VisibleFields?.Any(v => DocTools.AreEqual(v, nameof(Favorite.Created))); }
        public bool doUpdated { get => true == _request.VisibleFields?.Any(v => DocTools.AreEqual(v, nameof(Favorite.Updated))); }

        public bool doScope { get => true == _request.VisibleFields?.Any(v => DocTools.AreEqual(v, nameof(Favorite.Scope))); }
    }
