...
namespace Services.Dto
{
    ...
    public partial class Intervention : InterventionBase, IReturn<Intervention>, IDto, ICloneable
    {
        ...
        public new List<string> Select
        {
            ...
            set
            {
                ...
                _Select = DocPermissionFactory.SetSelect<Intervention>("Intervention",exists);
            }
        }
    ...
    public class InterventionFullTextSearch
    {
        ...
        public bool doCreated { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Intervention.Created))); }
        public bool doUpdated { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Intervention.Updated))); }

        public bool doDocumentSets { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Intervention.DocumentSets))); }
        public bool doName { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Intervention.Name))); }
        public bool doURI { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Intervention.URI))); }
    }
