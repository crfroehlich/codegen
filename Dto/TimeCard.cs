...
namespace Services.Dto
{
    ...
    public partial class TimeCard : TimeCardBase, IReturn<TimeCard>, IDto, ICloneable
    {
        ...
        public new List<string> Select
        {
            ...
            set
            {
                ...
                _Select = DocPermissionFactory.SetSelect<TimeCard>("TimeCard",exists);
            }
        }
    ...
    public class TimeCardFullTextSearch
    {
        ...
        public bool doCreated { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(TimeCard.Created))); }
        public bool doUpdated { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(TimeCard.Updated))); }

        public bool doDescription { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(TimeCard.Description))); }
        public bool doDocument { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(TimeCard.Document))); }
        public bool doEnd { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(TimeCard.End))); }
        public bool doProject { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(TimeCard.Project))); }
        public bool doReferenceId { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(TimeCard.ReferenceId))); }
        public bool doStart { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(TimeCard.Start))); }
        public bool doStatus { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(TimeCard.Status))); }
        public bool doUser { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(TimeCard.User))); }
        public bool doWorkType { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(TimeCard.WorkType))); }
    }
