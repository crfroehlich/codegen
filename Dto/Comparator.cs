...
namespace Services.Dto
{
    ...
    public partial class Comparator : ComparatorBase, IReturn<Comparator>, IDto, ICloneable
    {
        ...
        public new List<string> Select
        {
            ...
            set
            {
                ...
                _Select = DocPermissionFactory.SetSelect<Comparator>("Comparator",exists);
            }
        }
    ...
    public class ComparatorFullTextSearch
    {
        ...
        public bool doCreated { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Comparator.Created))); }
        public bool doUpdated { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Comparator.Updated))); }

        public bool doDocumentSets { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Comparator.DocumentSets))); }
        public bool doName { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Comparator.Name))); }
        public bool doURI { get => true == _request.Select?.Any(v => DocTools.AreEqual(v, nameof(Comparator.URI))); }
    }
