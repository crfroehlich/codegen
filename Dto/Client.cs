...
namespace Services.Dto
{
    ...
    [Route("/client/{Id}/lookuptablebinding/version", "GET, POST")]
    [Route("/client/{Id}/lookuptablebinding", "GET, POST, DELETE")]
    [Route("/client/{Id}/division/version", "GET, POST")]
    [Route("/client/{Id}/division", "GET, POST, DELETE")]
    [Route("/client/{Id}/documentset/version", "GET, POST")]
    [Route("/client/{Id}/documentset", "GET, POST, DELETE")]
    [Route("/client/{Id}/project/version", "GET, POST")]
    [Route("/client/{Id}/project", "GET, POST, DELETE")]
    [Route("/client/{Id}/scope/version", "GET, POST")]
    [Route("/client/{Id}/scope", "GET, POST, DELETE")]
    [Route("/client/{Id}/user/version", "GET, POST")]
    [Route("/client/{Id}/user", "GET, POST, DELETE")]
    [Route("/client/{Id}/workflow/version", "GET, POST")]
