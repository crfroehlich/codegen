...
namespace Services.Dto
{
    public abstract partial class UserSessionBase : Dto<UserSession>
    {
        ...
        [ApiMember(Name = nameof(ImpersonationsIds), Description = "Impersonation Ids", IsRequired = false)]
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public List<int> ImpersonationsIds { get; set; }
        [ApiMember(Name = nameof(ImpersonationsCount), Description = "Impersonation Count", IsRequired = false)]
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        ...
        [ApiMember(Name = nameof(RequestsIds), Description = "UserRequest Ids", IsRequired = false)]
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public List<int> RequestsIds { get; set; }
        [ApiMember(Name = nameof(RequestsCount), Description = "UserRequest Count", IsRequired = false)]
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
...
[GeneratedCodeAttribute("T4", "1.0.0.0")]
        ...
        [ApiMember(Name = nameof(UserHistoryIds), Description = "History Ids", IsRequired = false)]
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public List<int> UserHistoryIds { get; set; }
        [ApiMember(Name = nameof(UserHistoryCount), Description = "History Count", IsRequired = false)]
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
