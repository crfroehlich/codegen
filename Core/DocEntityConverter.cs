...
namespace Services.Core
{
    public static class DocEntityConverter
    {
        ...
        {
            TDto ret = null;
            var entityType = typeof(TEntity).Name.Replace("DocEntity", "");
            if (typeof(TEntity).BaseType.Name != "DocEntityBase" &&
                typeof(TEntity).BaseType.Name.StartsWith("DocEntity"))
            {
                entityType = typeof(TEntity).BaseType.Name.Replace("DocEntity", "");
            }
