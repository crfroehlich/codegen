...
namespace Services.API
{
    public partial class FavoriteService : DocServiceBase
    {
        ...
        private Favorite _AssignValues(Favorite request, DocConstantPermission permission, Session session)
        {
            ...
            DocPermissionFactory.SetVisibleFields<Favorite>(currentUser, nameof(Favorite), request.VisibleFields);
            ret = entity.ToDto();
        ...
        private Favorite GetFavorite(Favorite request)
        {
            ...
            DocPermissionFactory.SetVisibleFields<Favorite>(currentUser, "Favorite", request.VisibleFields);
