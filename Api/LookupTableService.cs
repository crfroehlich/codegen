...
namespace Services.API
{
    public partial class LookupTableService : DocServiceBase
    {
        ...
        public List<int> Any(LookupTableIds request)
        {
            List<int> ret = null;
            if (currentUser.IsSuperAdmin)
            {
                Execute.Run(s => { ret = Execute.SelectAll<DocEntityLookupTable>().Select(d => d.Id).ToList(); });
            }
            else
            {
...
===== [Custom After copyLookupTable] =====
===== [Custom Before copyLookupTable] =====
==================== Orphaned Custom Regions ====================
