...
namespace Services.API
{
    public partial class ServePortalSetService : DocServiceBase
    {
        ...
        private ServePortalSet _AssignValues(ServePortalSet request, DocConstantPermission permission, Session session)
        {
            ...
            idsToInvalidate.AddRange(PatchCollection<ServePortalSet, DocEntityServePortalSet, Reference, DocEntityClient>(request, entity, pClients, permission, nameof(request.Clients)));
            idsToInvalidate.AddRange(PatchCollection<ServePortalSet, DocEntityServePortalSet, Reference, DocEntityDivision>(request, entity, pDivisions, permission, nameof(request.Divisions)));
            idsToInvalidate.AddRange(PatchCollection<ServePortalSet, DocEntityServePortalSet, Reference, DocEntityDocument>(request, entity, pDocuments, permission, nameof(request.Documents)));
            idsToInvalidate.AddRange(PatchCollection<ServePortalSet, DocEntityServePortalSet, Reference, DocEntityDocumentSet>(request, entity, pDocumentSets, permission, nameof(request.DocumentSets)));
            idsToInvalidate.AddRange(PatchCollection<ServePortalSet, DocEntityServePortalSet, Reference, DocEntityTermCategory>(request, entity, pDrugClasses, permission, nameof(request.DrugClasses)));
            idsToInvalidate.AddRange(PatchCollection<ServePortalSet, DocEntityServePortalSet, Reference, DocEntityDocumentSetHistory>(request, entity, pHistories, permission, nameof(request.Histories)));
            idsToInvalidate.AddRange(PatchCollection<ServePortalSet, DocEntityServePortalSet, Reference, DocEntityTermMaster>(request, entity, pInterventions, permission, nameof(request.Interventions)));
            idsToInvalidate.AddRange(PatchCollection<ServePortalSet, DocEntityServePortalSet, Reference, DocEntityScope>(request, entity, pScopes, permission, nameof(request.Scopes)));
            idsToInvalidate.AddRange(PatchCollection<ServePortalSet, DocEntityServePortalSet, Reference, DocEntityStatsStudySet>(request, entity, pStats, permission, nameof(request.Stats)));
            idsToInvalidate.AddRange(PatchCollection<ServePortalSet, DocEntityServePortalSet, Reference, DocEntityUser>(request, entity, pUsers, permission, nameof(request.Users)));
