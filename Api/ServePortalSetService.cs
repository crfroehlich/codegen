...
{
    public partial class ServePortalSetService : DocServiceBase
    {
        ...
        public object Post(ServePortalSetSearch request) => Get(request);

        public object Get(ServePortalSetSearch request) => GetSearchResultWithCache<ServePortalSet,DocEntityServePortalSet,ServePortalSetSearch>(DocConstantModelName.SERVEPORTALSET, request, _ExecSearch);

        public object Get(ServePortalSet request) => GetEntityWithCache<ServePortalSet>(DocConstantModelName.SERVEPORTALSET, request, GetServePortalSet);



        private ServePortalSet _AssignValues(ServePortalSet request, DocConstantPermission permission, Session session)
        {
            if(permission != DocConstantPermission.ADD && (request == null || request.Id <= 0))
                throw new HttpError(HttpStatusCode.NotFound, $"No record");

            if(permission == DocConstantPermission.ADD && !DocPermissionFactory.HasPermissionTryAdd(currentUser, "ServePortalSet"))
                throw new HttpError(HttpStatusCode.Forbidden, "You do not have ADD permission for this route.");

            request.Select = request.Select ?? new List<string>();

            ServePortalSet ret = null;
            request = _InitAssignValues<ServePortalSet>(request, permission, session);
            ...
            var pDrugClasses = GetVariable<Reference>(request, nameof(request.DrugClasses), request.DrugClasses?.ToList(), request.DrugClassesIds?.ToList());
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<bool>(currentUser, request, pArchived, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.Archived)))
            {
                if(DocPermissionFactory.IsRequested(request, pArchived, entity.Archived, nameof(request.Archived)))
                    if (DocResources.Metadata.IsInsertOnly(DocConstantModelName.SERVEPORTALSET, nameof(request.Archived)) && DocConstantPermission.ADD != permission) throw new HttpError(HttpStatusCode.Forbidden, $"{nameof(request.Archived)} cannot be modified once set.");
                    if (DocTools.IsNullOrEmpty(pArchived) && DocResources.Metadata.IsRequired(DocConstantModelName.SERVEPORTALSET, nameof(request.Archived))) throw new HttpError(HttpStatusCode.BadRequest, $"{nameof(request.Archived)} requires a value.");
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<bool>(currentUser, request, pConfidential, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.Confidential)))
            {
                if(DocPermissionFactory.IsRequested(request, pConfidential, entity.Confidential, nameof(request.Confidential)))
                    if (DocResources.Metadata.IsInsertOnly(DocConstantModelName.SERVEPORTALSET, nameof(request.Confidential)) && DocConstantPermission.ADD != permission) throw new HttpError(HttpStatusCode.Forbidden, $"{nameof(request.Confidential)} cannot be modified once set.");
                    if (DocTools.IsNullOrEmpty(pConfidential) && DocResources.Metadata.IsRequired(DocConstantModelName.SERVEPORTALSET, nameof(request.Confidential))) throw new HttpError(HttpStatusCode.BadRequest, $"{nameof(request.Confidential)} requires a value.");
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<int?>(currentUser, request, pLegacyDocumentSetId, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.LegacyDocumentSetId)))
            {
                if(DocPermissionFactory.IsRequested(request, pLegacyDocumentSetId, entity.LegacyDocumentSetId, nameof(request.LegacyDocumentSetId)))
                    if (DocResources.Metadata.IsInsertOnly(DocConstantModelName.SERVEPORTALSET, nameof(request.LegacyDocumentSetId)) && DocConstantPermission.ADD != permission) throw new HttpError(HttpStatusCode.Forbidden, $"{nameof(request.LegacyDocumentSetId)} cannot be modified once set.");
                    if (DocTools.IsNullOrEmpty(pLegacyDocumentSetId) && DocResources.Metadata.IsRequired(DocConstantModelName.SERVEPORTALSET, nameof(request.LegacyDocumentSetId))) throw new HttpError(HttpStatusCode.BadRequest, $"{nameof(request.LegacyDocumentSetId)} requires a value.");
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<string>(currentUser, request, pName, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.Name)))
            {
                if(DocPermissionFactory.IsRequested(request, pName, entity.Name, nameof(request.Name)))
                    if (DocResources.Metadata.IsInsertOnly(DocConstantModelName.SERVEPORTALSET, nameof(request.Name)) && DocConstantPermission.ADD != permission) throw new HttpError(HttpStatusCode.Forbidden, $"{nameof(request.Name)} cannot be modified once set.");
                    if (DocTools.IsNullOrEmpty(pName) && DocResources.Metadata.IsRequired(DocConstantModelName.SERVEPORTALSET, nameof(request.Name))) throw new HttpError(HttpStatusCode.BadRequest, $"{nameof(request.Name)} requires a value.");
                    entity.Name = pName;
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<DocEntityDocumentSet>(currentUser, request, pOwner, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.Owner)))
            {
                if(DocPermissionFactory.IsRequested(request, pOwner, entity.Owner, nameof(request.Owner)))
                    if (DocResources.Metadata.IsInsertOnly(DocConstantModelName.SERVEPORTALSET, nameof(request.Owner)) && DocConstantPermission.ADD != permission) throw new HttpError(HttpStatusCode.Forbidden, $"{nameof(request.Owner)} cannot be modified once set.");
                    if (DocTools.IsNullOrEmpty(pOwner) && DocResources.Metadata.IsRequired(DocConstantModelName.SERVEPORTALSET, nameof(request.Owner))) throw new HttpError(HttpStatusCode.BadRequest, $"{nameof(request.Owner)} requires a value.");
                    entity.Owner = pOwner;
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<DocEntityTeam>(currentUser, request, pProjectTeam, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.ProjectTeam)))
            {
                if(DocPermissionFactory.IsRequested(request, pProjectTeam, entity.ProjectTeam, nameof(request.ProjectTeam)))
                    if (DocResources.Metadata.IsInsertOnly(DocConstantModelName.SERVEPORTALSET, nameof(request.ProjectTeam)) && DocConstantPermission.ADD != permission) throw new HttpError(HttpStatusCode.Forbidden, $"{nameof(request.ProjectTeam)} cannot be modified once set.");
                    if (DocTools.IsNullOrEmpty(pProjectTeam) && DocResources.Metadata.IsRequired(DocConstantModelName.SERVEPORTALSET, nameof(request.ProjectTeam))) throw new HttpError(HttpStatusCode.BadRequest, $"{nameof(request.ProjectTeam)} requires a value.");
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<string>(currentUser, request, pSettings, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.Settings)))
            {
                if(DocPermissionFactory.IsRequested(request, pSettings, entity.Settings, nameof(request.Settings)))
                    if (DocResources.Metadata.IsInsertOnly(DocConstantModelName.SERVEPORTALSET, nameof(request.Settings)) && DocConstantPermission.ADD != permission) throw new HttpError(HttpStatusCode.Forbidden, $"{nameof(request.Settings)} cannot be modified once set.");
                    if (DocTools.IsNullOrEmpty(pSettings) && DocResources.Metadata.IsRequired(DocConstantModelName.SERVEPORTALSET, nameof(request.Settings))) throw new HttpError(HttpStatusCode.BadRequest, $"{nameof(request.Settings)} requires a value.");
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<DocumentSetTypeEnm?>(currentUser, request, pType, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.Type)))
            {
                if(DocPermissionFactory.IsRequested(request, (int?) pType, (int) entity.Type, nameof(request.Type)))
                    if (DocResources.Metadata.IsInsertOnly(DocConstantModelName.SERVEPORTALSET, nameof(request.Type)) && DocConstantPermission.ADD != permission) throw new HttpError(HttpStatusCode.Forbidden, $"{nameof(request.Type)} cannot be modified once set.");
                    if (DocTools.IsNullOrEmpty(pType) && DocResources.Metadata.IsRequired(DocConstantModelName.SERVEPORTALSET, nameof(request.Type))) throw new HttpError(HttpStatusCode.BadRequest, $"{nameof(request.Type)} requires a value.");
                    if(null != pType)
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<List<Reference>>(currentUser, request, pClients, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.Clients)))
            {
                if (true == pClients?.Any() )
                {
                    ...
                    toAdd?.ForEach(id =>
                    {
                        ...
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.ADD, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Clients)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to add {nameof(request.Clients)} to {nameof(ServePortalSet)}");
                    ...
                    {
                        var target = DocEntityClient.Get(id);
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.REMOVE, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Clients)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to remove {nameof(request.Clients)} from {nameof(ServePortalSet)}");
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<List<Reference>>(currentUser, request, pDivisions, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.Divisions)))
            {
                if (true == pDivisions?.Any() )
                {
                    ...
                    toAdd?.ForEach(id =>
                    {
                        ...
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.ADD, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Divisions)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to add {nameof(request.Divisions)} to {nameof(ServePortalSet)}");
                    ...
                    {
                        var target = DocEntityDivision.Get(id);
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.REMOVE, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Divisions)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to remove {nameof(request.Divisions)} from {nameof(ServePortalSet)}");
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<List<Reference>>(currentUser, request, pDocuments, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.Documents)))
            {
                if (true == pDocuments?.Any() )
                {
                    ...
                    toAdd?.ForEach(id =>
                    {
                        ...
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.ADD, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Documents)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to add {nameof(request.Documents)} to {nameof(ServePortalSet)}");
                    ...
                    {
                        var target = DocEntityDocument.Get(id);
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.REMOVE, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Documents)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to remove {nameof(request.Documents)} from {nameof(ServePortalSet)}");
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<List<Reference>>(currentUser, request, pDocumentSets, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.DocumentSets)))
            {
                if (true == pDocumentSets?.Any() )
                {
                    ...
                    toAdd?.ForEach(id =>
                    {
                        ...
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.ADD, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.DocumentSets)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to add {nameof(request.DocumentSets)} to {nameof(ServePortalSet)}");
                    ...
                    {
                        var target = DocEntityDocumentSet.Get(id);
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.REMOVE, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.DocumentSets)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to remove {nameof(request.DocumentSets)} from {nameof(ServePortalSet)}");
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<List<Reference>>(currentUser, request, pHistories, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.Histories)))
            {
                if (true == pHistories?.Any() )
                {
                    ...
                    toAdd?.ForEach(id =>
                    {
                        ...
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.ADD, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Histories)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to add {nameof(request.Histories)} to {nameof(ServePortalSet)}");
                    ...
                    {
                        var target = DocEntityDocumentSetHistory.Get(id);
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.REMOVE, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Histories)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to remove {nameof(request.Histories)} from {nameof(ServePortalSet)}");
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<List<Reference>>(currentUser, request, pInterventions, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.Interventions)))
            {
                if (true == pInterventions?.Any() )
                {
                    var requestedInterventions = pInterventions.Select(p => p.Id).Distinct().ToList();
                    var existsInterventions = Execute.SelectAll<DocEntityTermMaster>().Where(e => e.Id.In(requestedInterventions)).Select( e => e.Id ).ToList();
                    ...
                    toAdd?.ForEach(id =>
                    {
                        ...
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.ADD, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Interventions)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to add {nameof(request.Interventions)} to {nameof(ServePortalSet)}");
                    ...
                    {
                        var target = DocEntityTermMaster.Get(id);
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.REMOVE, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Interventions)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to remove {nameof(request.Interventions)} from {nameof(ServePortalSet)}");
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<List<Reference>>(currentUser, request, pScopes, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.Scopes)))
            {
                if (true == pScopes?.Any() )
                {
                    ...
                    toAdd?.ForEach(id =>
                    {
                        ...
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.ADD, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Scopes)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to add {nameof(request.Scopes)} to {nameof(ServePortalSet)}");
                    ...
                    {
                        var target = DocEntityScope.Get(id);
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.REMOVE, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Scopes)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to remove {nameof(request.Scopes)} from {nameof(ServePortalSet)}");
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<List<Reference>>(currentUser, request, pStats, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.Stats)))
            {
                if (true == pStats?.Any() )
                {
                    ...
                    toAdd?.ForEach(id =>
                    {
                        ...
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.ADD, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Stats)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to add {nameof(request.Stats)} to {nameof(ServePortalSet)}");
                    ...
                    {
                        var target = DocEntityStatsStudySet.Get(id);
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.REMOVE, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Stats)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to remove {nameof(request.Stats)} from {nameof(ServePortalSet)}");
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<List<Reference>>(currentUser, request, pUsers, permission, DocConstantModelName.SERVEPORTALSET, nameof(request.Users)))
            {
                if (true == pUsers?.Any() )
                {
                    ...
                    toAdd?.ForEach(id =>
                    {
                        ...
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.ADD, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Users)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to add {nameof(request.Users)} to {nameof(ServePortalSet)}");
                    ...
                    {
                        var target = DocEntityUser.Get(id);
                        if(!DocPermissionFactory.HasPermission(entity, currentUser, DocConstantPermission.REMOVE, targetEntity: target, targetName: nameof(ServePortalSet), columnName: nameof(request.Users)))
                            throw new HttpError(HttpStatusCode.Forbidden, "You do not have permission to remove {nameof(request.Users)} from {nameof(ServePortalSet)}");
            ...
            DocPermissionFactory.SetSelect<ServePortalSet>(currentUser, nameof(ServePortalSet), request.Select);
            ret = entity.ToDto();

            var cacheExpires = DocResources.Metadata.GetCacheExpiration(DocConstantModelName.SERVEPORTALSET);
            DocCacheClient.Set(key: cacheKey, value: ret, entityId: request.Id, entityType: DocConstantModelName.SERVEPORTALSET, cacheExpires);

            return ret;
        }


        public ServePortalSet Post(ServePortalSet request)
        {
            ...
            using(Execute)
            {
                Execute.Run(ssn =>
                {
                    if(!DocPermissionFactory.HasPermissionTryAdd(currentUser, "ServePortalSet")) 
                        throw new HttpError(HttpStatusCode.Forbidden, "You do not have ADD permission for this route.");
        ...
        public List<ServePortalSet> Post(ServePortalSetBatch request)
        {
            if(true != request?.Any()) throw new HttpError(HttpStatusCode.NotFound, "Request cannot be empty.");

            var ret = new List<ServePortalSet>();
            ...
            request.ForEach(dto =>
            {
                try
                {
                    var obj = Post(dto) as ServePortalSet;
                    ret.Add(obj);
                    errorMap[$"{i}"] = $"{obj.Id}";
                }
                catch (Exception ex)
        ...
        public List<ServePortalSet> Put(ServePortalSetBatch request)
        {
            return Patch(request);
        }

        public ServePortalSet Put(ServePortalSet request)
        {
            return Patch(request);
        }


        public List<ServePortalSet> Patch(ServePortalSetBatch request)
        {
            if(true != request?.Any()) throw new HttpError(HttpStatusCode.NotFound, "Request cannot be empty.");
            ...
            request.ForEach(dto =>
            {
                try
                {
                    var obj = Patch(dto) as ServePortalSet;
                    ret.Add(obj);
                    errorMap[$"{i}"] = $"true";
                }
                catch (Exception ex)
        ...
        public ServePortalSet Patch(ServePortalSet request)
        {
            if(true != (request?.Id > 0)) throw new HttpError(HttpStatusCode.NotFound, "Please specify a valid Id of the ServePortalSet to patch.");
        ...
        public void Delete(ServePortalSetBatch request)
        {
            if(true != request?.Any()) throw new HttpError(HttpStatusCode.NotFound, "Request cannot be empty.");
        ...
        public void Delete(ServePortalSet request)
        {
            using(Execute)
            {
                Execute.Run(ssn =>
                {
                    ...
                    if(null == en) throw new HttpError(HttpStatusCode.NotFound, $"No ServePortalSet could be found for Id {request?.Id}.");
        ...
        public void Delete(ServePortalSetSearch request)
        {
            var matches = Get(request) as List<ServePortalSet>;
        ...
        public object Get(ServePortalSetJunction request)
        {
        ...
        public object Post(ServePortalSetJunction request)
        {
            switch(request.Junction.ToLower().TrimAndPruneSpaces())
            {
                    case "client":
        ...
        public object Delete(ServePortalSetJunction request)
        {    
            switch(request.Junction.ToLower().TrimAndPruneSpaces())
            {
                    case "client":
