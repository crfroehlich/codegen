...
namespace Services.API
{
    public partial class TherapeuticAreaSetService : DocServiceBase
    {
        ...
        private TherapeuticAreaSet _AssignValues(TherapeuticAreaSet request, DocConstantPermission permission, Session session)
        {
            ...
            if (PatchValue<TherapeuticAreaSet, bool>(request, DocConstantModelName.THERAPEUTICAREASET, pArchived, entity.Archived, permission, nameof(request.Archived), pArchived != entity.Archived))
            {
                entity.Archived = pArchived;
            }
            if (PatchValue<TherapeuticAreaSet, bool>(request, DocConstantModelName.THERAPEUTICAREASET, pConfidential, entity.Confidential, permission, nameof(request.Confidential), pConfidential != entity.Confidential))
            {
                entity.Confidential = pConfidential;
            }
            if (PatchValue<TherapeuticAreaSet, int?>(request, DocConstantModelName.THERAPEUTICAREASET, pLegacyDocumentSetId, entity.LegacyDocumentSetId, permission, nameof(request.LegacyDocumentSetId), pLegacyDocumentSetId != entity.LegacyDocumentSetId))
            {
                entity.LegacyDocumentSetId = pLegacyDocumentSetId;
            }
            if (PatchValue<TherapeuticAreaSet, string>(request, DocConstantModelName.THERAPEUTICAREASET, pName, entity.Name, permission, nameof(request.Name), pName != entity.Name))
            {
                entity.Name = pName;
            }
            if (PatchValue<TherapeuticAreaSet, DocEntityDocumentSet>(request, DocConstantModelName.THERAPEUTICAREASET, pOwner, entity.Owner, permission, nameof(request.Owner), pOwner != entity.Owner))
            {
                entity.Owner = pOwner;
            }
            if (PatchValue<TherapeuticAreaSet, DocEntityTeam>(request, DocConstantModelName.THERAPEUTICAREASET, pProjectTeam, entity.ProjectTeam, permission, nameof(request.ProjectTeam), pProjectTeam != entity.ProjectTeam))
            {
                entity.ProjectTeam = pProjectTeam;
            }
            if (PatchValue<TherapeuticAreaSet, string>(request, DocConstantModelName.THERAPEUTICAREASET, pSettings, entity.Settings, permission, nameof(request.Settings), pSettings != entity.Settings))
            {
                entity.Settings = pSettings;
            }
            if (PatchValue<TherapeuticAreaSet, DocumentSetTypeEnm?>(request, DocConstantModelName.THERAPEUTICAREASET, pType, entity.Type, permission, nameof(request.Type), pType != entity.Type))
            {
