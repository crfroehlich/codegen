...
namespace Services.API
{
    public partial class UserSessionService : DocServiceBase
    {
        ...
        public object Get(UserSessionJunction request)
        {
            ...
            {
                    case "comment":
                        return GetJunctionSearchResult<UserSession, DocEntityUserSession, DocEntityComment, Comment, CommentSearch>((int)request.Id, DocConstantModelName.COMMENT, "Comments", request, (ss) => HostContext.ResolveService<CommentService>(Request)?.Get(ss));
                    case "favorite":
