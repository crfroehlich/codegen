...
namespace Services.API
{
    public partial class CharacteristicService : DocServiceBase
    {
        ...
        private Characteristic _AssignValues(Characteristic dtoSource, DocConstantPermission permission, Session session)
        {
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<string>(currentUser, dtoSource, pName, permission, DocConstantModelName.CHARACTERISTIC, nameof(dtoSource.Name)))
            {
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<string>(currentUser, dtoSource, pURI, permission, DocConstantModelName.CHARACTERISTIC, nameof(dtoSource.URI)))
            {
            ...
            DocPermissionFactory.SetVisibleFields<Characteristic>(currentUser, nameof(Characteristic), dtoSource.VisibleFields);
            ret = entity.ToDto();

            return ret;
        }
        public Characteristic Post(Characteristic dtoSource)
        {
        ...
        public Characteristic Put(Characteristic dtoSource)
        {
        ...
        public Characteristic Patch(Characteristic dtoSource)
        {
