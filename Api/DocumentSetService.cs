        ...
        public object Get(DocumentSetJunction request)
        {
            ...
            Execute.Run( s => 
            {
                ...
                case "outcome":
                    ...
                    break;
                case "package":
                    ret = GetJunctionSearchResult<DocumentSet, DocEntityDocumentSet, DocEntityPackage, Package, PackageSearch>((int)request.Id, DocConstantModelName.PACKAGE, "Packages", request,
                        (ss) =>
                        { 
                    ...
                    break;
                case "projectlink":
                    ret = GetJunctionSearchResult<DocumentSet, DocEntityDocumentSet, DocEntityPackage, Package, PackageSearch>((int)request.Id, DocConstantModelName.PACKAGE, "ProjectLinks", request,
                        (ss) =>
                        { 
                            var service = HostContext.ResolveService<PackageService>(Request);
                            return service.Get(ss);
