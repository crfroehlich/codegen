    ...
    public partial class DocumentSetService : DocServiceBase
    {
        ...
        private DocumentSet _AssignValues(DocumentSet request, DocConstantPermission permission, Session session)
        {
            ...
            if (DocPermissionFactory.IsRequestedHasPermission<bool>(currentUser, request, pShowPublicationType, permission, DocConstantModelName.DOCUMENTSET, nameof(request.ShowPublicationType)))
            {
                ...
                if(DocPermissionFactory.IsRequested<bool>(request, pShowPublicationType, nameof(request.ShowPublicationType)) && !request.VisibleFields.Matches(nameof(request.ShowPublicationType), ignoreSpaces: true))
                {
                    request.VisibleFields.Add(nameof(request.ShowPublicationType));
                }
            }
