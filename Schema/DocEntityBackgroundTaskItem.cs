...
namespace Services.Schema
{
    ...
    public partial class DocEntityBackgroundTaskItem : DocEntityBase
    {
        ...
        public DocEntityBackgroundTaskItem(Session session)
            : base(session) { }

        /// <summary>
        ///    Initializes a new instance of this class as a default, session-less object.
        /// </summary>
        public DocEntityBackgroundTaskItem()
        ...
        /// <summary>
        ///    The Model name of this class is <see cref="DocConstantModelName.BACKGROUNDTASKITEM" />
        /// </summary>
        public static readonly DocConstantModelName MODEL_NAME = DocConstantModelName.BACKGROUNDTASKITEM;
        ...
        public override bool UnlockRecord()
        {
            ...
            _OnUnlock();
            if (!ret) throw new ServiceStack.HttpError(System.Net.HttpStatusCode.Forbidden, $"You do not have permission to unlock this {nameof(BackgroundTaskItem)}");
            if (ret)
            {
                _isNewlyLocked = true;
                Locked = false;
        ...
        {
            _OnFlushCache();
            DocCacheClient.RemoveSearch("BackgroundTaskItem");
        }
        ...
        public static Guid GetGuid(DocEntityBackgroundTaskItem thing)
        {
