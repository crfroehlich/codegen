...
namespace Services.Schema
{
    ...
    public partial class DocEntityImportData : DocEntityBase
    {
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public static DocEntityImportData Get(Reference reference) => (true == (reference?.Id > 0)) ? Get(reference.Id) : null;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public static DocEntityImportData Get(int? primaryKey, bool noCache, DocQuery query)
        {
