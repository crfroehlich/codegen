...
namespace Services.Schema
{
    ...
    public partial class DocEntityMeanRanges : DocEntityBase
    {
        ...
        /// <summary>
        ///    The Model name of this class is <see cref="DocConstantModelName.MEANRANGES" />
        /// </summary>
        ...
        {
            return  (T) ((IDocModel) ToMeanRanges());
