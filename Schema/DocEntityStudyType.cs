...
namespace Services.Schema
{
    ...
    public partial class DocEntityStudyType : DocEntityBase
    {
        ...
        /// <summary>
        ///    The Model name of this class is <see cref="DocConstantModelName.STUDYTYPE" />
        /// </summary>
        public static readonly DocConstantModelName MODEL_NAME = DocConstantModelName.STUDYTYPE;
        ...
        public override bool UnlockRecord()
        {
            ...
            _OnUnlock();
            if (!ret) throw new ServiceStack.HttpError(System.Net.HttpStatusCode.Forbidden, $"You do not have permission to unlock this {nameof(StudyType)}");
            if (ret)
            {
                _isNewlyLocked = true;
                Locked = false;
        ...
        {
            _OnFlushCache();
            DocCacheClient.RemoveSearch("StudyType");
        ...
        public static Guid GetGuid(DocEntityStudyType thing)
        {
