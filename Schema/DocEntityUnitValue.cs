...
namespace Services.Schema
{
    ...
    public partial class DocEntityUnitValue : DocEntityBase
    {
        ...
        /// <summary>
        ///    The Model name of this class is <see cref="DocConstantModelName.UNITVALUE" />
        /// </summary>
        ...
        {
            return  (T) ((IDocModel) ToUnitValue());
