...
namespace Services.Schema
{
    ...
    public partial class DocEntityAuditDelta : DocEntityBase
    {
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityAuditDelta Get(Reference reference) => (true == (reference?.Id > 0)) ? Get(reference.Id) : null;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityAuditDelta Get(int? primaryKey, bool noCache, DocQuery query)
        {
