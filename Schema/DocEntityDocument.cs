...
namespace Services.Schema
{
    ...
    public partial class DocEntityDocument : DocEntityBase
    {
        ...
        [Association( PairTo = nameof(VariableInstance.Document), OnOwnerRemove = OnRemoveAction.Clear, OnTargetRemove = OnRemoveAction.Clear )]
        ...
        /// <summary>
        ///    The Model name of this class is <see cref="DocConstantModelName.DOCUMENT" />
        /// </summary>
        public static readonly DocConstantModelName MODEL_NAME = DocConstantModelName.DOCUMENT;
        ...
        public override bool UnlockRecord()
        {
            ...
            _OnUnlock();
            if (!ret) throw new ServiceStack.HttpError(System.Net.HttpStatusCode.Forbidden, $"You do not have permission to unlock this {nameof(Document)}");
            if (ret)
            {
                _isNewlyLocked = true;
                Locked = false;
        ...
        {
            _OnFlushCache();
            DocCacheClient.RemoveSearch("Document");
        ...
        public static Guid GetGuid(DocDocument thing)
        {
                var guid = Guid.Empty;
            ...
            var ret = new DocCommaDelimitedString();
                ...
                if(null == thing.ReferenceStudy)
                {
                    ret.Add($"ReferenceStudy:{DocConvert.NullGuid}");
                }
                else
                {
                    if(int.MinValue == thing.ReferenceStudy)
                    {
                        ret.Add($"ReferenceStudy:{DocConvert.NullGuid}");
                    }
                    else
                    {
                        ret.Add($"ReferenceStudy:{thing.ReferenceStudy}");
                    }
            }
        ...
        public static Guid GetGuid(DocEntityDocument thing)
        {
    ...
    public partial class DocumentMapper : Profile
    {
