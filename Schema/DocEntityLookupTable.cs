...
namespace Services.Schema
{
    ...
    public partial class DocEntityLookupTable : DocEntityBase
    {
        ...
        {
            return (true == (reference?.Id > 0)) ? GetLookupTable(reference.Id) : null;
        }

        public static DocEntityLookupTable GetLookupTable(int? primaryKey)
        {
        ...
        public static DocEntityLookupTable GetLookupTable(Guid hash)
        {
            var query = DocQuery.ActiveQuery;
        ...
        [Association( PairTo = nameof(LookupTableBinding.LookupTable), OnOwnerRemove = OnRemoveAction.Cascade, OnTargetRemove = OnRemoveAction.Clear )]
        ...
        [Association( PairTo = nameof(Document.LookupTables), OnOwnerRemove = OnRemoveAction.Clear, OnTargetRemove = OnRemoveAction.Clear )]
        ...
        /// <summary>
        ///    The Model name of this class is <see cref="DocConstantModelName.LOOKUPTABLE" />
        /// </summary>
        public static readonly DocConstantModelName MODEL_NAME = DocConstantModelName.LOOKUPTABLE;
        ...
        {
            return  (T) ((IDocModel) ToLookupTable());
        ...
        public override bool UnlockRecord()
        {
            ...
            _OnUnlock();
            if (!ret) throw new ServiceStack.HttpError(System.Net.HttpStatusCode.Forbidden, $"You do not have permission to unlock this {nameof(LookupTable)}");
            if (ret)
            {
                _isNewlyLocked = true;
                Locked = false;
        ...
        {
            _OnFlushCache();
            DocCacheClient.RemoveSearch("LookupTable");
        ...
        public static Guid GetGuid(DocLookupTable thing)
        {
                var guid = Guid.Empty;
            ...
            var ret = new DocCommaDelimitedString();
                ...
                if(null == thing.Enum || thing.Enum.Id <= 0)
                {
                    ret.Add($"Enum:{DocConvert.NullGuid}");
                }
                else
                {
                    ret.Add($"Enum:{thing.Enum.Id}");
            }
                if(null == thing.Name)
                {
        ...
        public static Guid GetGuid(DocEntityLookupTable thing)
        {
