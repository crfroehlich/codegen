...
namespace Services.Schema
{
    ...
    public partial class DocEntityStudyDesign : DocEntityBase
    {
        ...
        /// <summary>
        ///    The Model name of this class is <see cref="DocConstantModelName.STUDYDESIGN" />
        /// </summary>
        public static readonly DocConstantModelName MODEL_NAME = DocConstantModelName.STUDYDESIGN;
        ...
        public override bool UnlockRecord()
        {
            ...
            _OnUnlock();
            if (!ret) throw new ServiceStack.HttpError(System.Net.HttpStatusCode.Forbidden, $"You do not have permission to unlock this {nameof(StudyDesign)}");
            if (ret)
            {
                _isNewlyLocked = true;
                Locked = false;
        ...
        {
            _OnFlushCache();
            DocCacheClient.RemoveSearch("StudyDesign");
        }
        ...
        public static Guid GetGuid(DocEntityStudyDesign thing)
        {
    ...
    public partial class StudyDesignMapper : Profile
    {
