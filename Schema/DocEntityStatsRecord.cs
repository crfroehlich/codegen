...
namespace Services.Schema
{
    ...
    public partial class DocEntityStatsRecord : DocEntityBase
    {
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public static DocEntityStatsRecord Get(Reference reference) => (true == (reference?.Id > 0)) ? Get(reference.Id) : null;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public static DocEntityStatsRecord Get(int? primaryKey, bool noCache, DocQuery query)
        {
