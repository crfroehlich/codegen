...
namespace Services.Schema
{
    ...
    public partial class DocEntityStatsRecord : DocEntityBase
    {
        ...
        /// <summary>
        ///    The Model name of this class is <see cref="DocConstantModelName.STATSRECORD" />
        /// </summary>
        public static readonly DocConstantModelName MODEL_NAME = DocConstantModelName.STATSRECORD;
        ...
        public override bool UnlockRecord()
        {
            ...
            _OnUnlock();
            if (!ret) throw new ServiceStack.HttpError(System.Net.HttpStatusCode.Forbidden, $"You do not have permission to unlock this {nameof(StatsRecord)}");
            if (ret)
            {
                _isNewlyLocked = true;
                Locked = false;
        ...
        {
            _OnFlushCache();
            DocCacheClient.RemoveSearch("StatsRecord");
        }
        ...
        public static Guid GetGuid(DocEntityStatsRecord thing)
        {
