...
namespace Services.Schema
{
    ...
    public partial class DocEntityTimeCard : DocEntityBase
    {
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityTimeCard Get(Reference reference) => (true == (reference?.Id > 0)) ? Get(reference.Id) : null;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityTimeCard Get(int? primaryKey, bool noCache, DocQuery query)
        {
