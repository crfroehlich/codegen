...
namespace Services.Schema
{
    ...
    public partial class DocEntityProject : DocEntityBase
    {
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityProject Get(Reference reference) => (true == (reference?.Id > 0)) ? Get(reference.Id) : null;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityProject Get(int? primaryKey, bool noCache, DocQuery query)
        {
