...
namespace Services.Schema
{
    ...
    public partial class DocEntityDefault : DocEntityBase
    {
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public  const ModelNameEnm CLASS_NAME = ModelNameEnm.DEFAULT;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityDefault Get(Reference reference) => (true == (reference?.Id > 0)) ? Get(reference.Id) : null;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityDefault Get(int? primaryKey, bool noCache, DocQuery query)
        {
            if(!(primaryKey > 0)) return null;
            return query.SelectAll<DocEntityDefault>().FirstOrDefault(e => e.Id == primaryKey.Value);
        }
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityDefault Get(int? primaryKey)
        {
