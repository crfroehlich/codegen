...
namespace Services.Schema
{
    ...
    public partial class DocEntityLibrarySet : DocEntityDocumentSet
    {
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new const ModelNameEnm CLASS_NAME = ModelNameEnm.LIBRARYSET;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityLibrarySet Get(Reference reference) => (true == (reference?.Id > 0)) ? Get(reference.Id) : null;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityLibrarySet Get(int? primaryKey, bool noCache, DocQuery query)
        {
            if(!(primaryKey > 0)) return null;
            return query.SelectAll<DocEntityLibrarySet>().FirstOrDefault(e => e.Id == primaryKey.Value);
        }
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityLibrarySet Get(int? primaryKey)
        {
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityLibrarySet Get(Guid hash)
        {
            var query = DocQuery.ActiveQuery;
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new const string CACHE_KEY_PREFIX = "FindLibrarySets";
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new LibrarySet ToDto() => Mapper.Map<DocEntityLibrarySet, LibrarySet>(this);
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
