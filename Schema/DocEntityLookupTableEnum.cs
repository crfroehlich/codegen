...
namespace Services.Schema
{
    ...
    public partial class DocEntityLookupTableEnum : DocEntityBase
    {
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityLookupTableEnum Get(Reference reference) => (true == (reference?.Id > 0)) ? Get(reference.Id) : null;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityLookupTableEnum Get(int? primaryKey, bool noCache, DocQuery query)
        {
