...
namespace Services.Schema
{
    ...
    public partial class DocEntityUpdate : DocEntityBase
    {
        ...
        [Association( PairTo = nameof(Event.Updates), OnOwnerRemove = OnRemoveAction.Cascade, OnTargetRemove = OnRemoveAction.Clear )]
        ...
        protected override void OnRemoving()
        {
            ...
            {
                throw new DocException("Failed to delete Update in Events delete", ex);
            }
            base.OnRemoving();
        }
