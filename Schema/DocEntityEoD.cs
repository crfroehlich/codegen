...
namespace Services.Schema
{
    ...
    public partial class DocEntityEoD : DocEntityTask
    {
        ...
        public const string TABLE_NAME = DocConstantModelName.EOD;
        ...
        protected override List<string> _visibleFields => __vf ?? (__vf = DocWebSession.GetTypeVisibleFields(new EoD()));
