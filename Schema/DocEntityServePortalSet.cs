...
namespace Services.Schema
{
    ...
    public partial class DocEntityServePortalSet : DocEntityDocumentSet
    {
        ...
        public static DocEntityServePortalSet Get(int? primaryKey, bool noCache, DocQuery query)
        {
            if(!(primaryKey > 0)) return null;
            return query.SelectAll<DocEntityServePortalSet>().FirstOrDefault(e => e.Id == primaryKey.Value);
        }

        public static DocEntityServePortalSet Get(int? primaryKey)
        {
        ...
        public static DocEntityServePortalSet Get(Guid hash)
        {
            var query = DocQuery.ActiveQuery;
