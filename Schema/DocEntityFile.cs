...
namespace Services.Schema
{
    ...
    public partial class DocEntityFile : DocEntityBase
    {
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityFile Get(Reference reference) => (true == (reference?.Id > 0)) ? Get(reference.Id) : null;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityFile Get(int? primaryKey, bool noCache, DocQuery query)
        {
