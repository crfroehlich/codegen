...
namespace Services.Schema
{
    ...
    public partial class DocEntityUnits : DocEntityBase
    {
        ...
        [Association( PairTo = nameof(UnitValue.Owners), OnOwnerRemove = OnRemoveAction.Clear, OnTargetRemove = OnRemoveAction.Clear )]
        ...
        /// <summary>
        ///    The Model name of this class is <see cref="DocConstantModelName.UNITS" />
        /// </summary>
        public static readonly DocConstantModelName MODEL_NAME = DocConstantModelName.UNITS;
        ...
        public override bool UnlockRecord()
        {
            ...
            _OnUnlock();
            if (!ret) throw new ServiceStack.HttpError(System.Net.HttpStatusCode.Forbidden, $"You do not have permission to unlock this {nameof(Units)}");
            if (ret)
            {
                _isNewlyLocked = true;
                Locked = false;
        ...
        {
            _OnFlushCache();
            DocCacheClient.RemoveSearch("Units");
        }
        ...
        public static Guid GetGuid(DocUnits thing)
        {
                var guid = Guid.Empty;
            ...
            var ret = new DocCommaDelimitedString();
                ...
                if(null == thing.Units || false == thing.Units.Any())
                {
                    ret.Add($"Units:{DocConvert.NullGuid}");
                }
                else
                {
                    ret.Add($"Units:{thing.Units.GetGuid()}");
            }
        ...
        public static Guid GetGuid(DocEntityUnits thing)
        {
    ...
    public partial class UnitsDtoMapper : Profile
    {
