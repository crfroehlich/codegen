...
namespace Services.Schema
{
    ...
    public partial class DocEntityTask : DocEntityBase
    {
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public static DocEntityTask Get(Reference reference) => (true == (reference?.Id > 0)) ? Get(reference.Id) : null;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public static DocEntityTask Get(int? primaryKey, bool noCache, DocQuery query)
        {
