...
namespace Services.Schema
{
    ...
    public partial class DocEntityTag : DocEntityBase
    {
        ...
        public DocEntityTag(Session session)
            : base(session) { }
        ...
        /// <summary>
        ///    The Model name of this class is <see cref="DocConstantModelName.TAG" />
        /// </summary>
        public static readonly DocConstantModelName MODEL_NAME = DocConstantModelName.TAG;
        ...
        public override bool UnlockRecord()
        {
            ...
            _OnUnlock();
            if (!ret) throw new ServiceStack.HttpError(System.Net.HttpStatusCode.Forbidden, $"You do not have permission to unlock this {nameof(Tag)}");
            if (ret)
            {
                _isNewlyLocked = true;
                Locked = false;
        ...
        {
            _OnFlushCache();
            DocCacheClient.RemoveSearch("Tag");
        ...
        public static Guid GetGuid(DocEntityTag thing)
        {
