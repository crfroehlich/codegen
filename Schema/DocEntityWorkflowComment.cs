...
namespace Services.Schema
{
    ...
    public partial class DocEntityWorkflowComment : DocEntityBase
    {
        ...
        public DocEntityWorkflowComment(Session session)
            : base(session) { }

        /// <summary>
        ///    Initializes a new instance of this class as a default, session-less object.
        /// </summary>
        public DocEntityWorkflowComment()
        ...
        /// <summary>
        ///    The Model name of this class is <see cref="DocConstantModelName.WORKFLOWCOMMENT" />
        /// </summary>
        public static readonly DocConstantModelName MODEL_NAME = DocConstantModelName.WORKFLOWCOMMENT;
        ...
        public override bool UnlockRecord()
        {
            ...
            _OnUnlock();
            if (!ret) throw new ServiceStack.HttpError(System.Net.HttpStatusCode.Forbidden, $"You do not have permission to unlock this {nameof(WorkflowComment)}");
            if (ret)
            {
                _isNewlyLocked = true;
                Locked = false;
        ...
        {
            _OnFlushCache();
            DocCacheClient.RemoveSearch("WorkflowComment");
        }
        ...
        public static Guid GetGuid(DocEntityWorkflowComment thing)
        {
