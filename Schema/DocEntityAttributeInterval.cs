...
namespace Services.Schema
{
    ...
    public partial class DocEntityAttributeInterval : DocEntityBase
    {
        ...
        public override bool UnlockRecord()
        {
            ...
            _OnUnlock();
            if (!ret) throw new ServiceStack.HttpError(System.Net.HttpStatusCode.Forbidden, $"You do not have permission to unlock this {nameof(AttributeInterval)}");
            if (ret)
            {
                _isNewlyLocked = true;
                Locked = false;
        ...
        public static Guid GetGuid(DocAttributeInterval thing)
        {
            ...
            var ret = new DocCommaDelimitedString();
                ...
                if(null == thing.Interval)
                {
                    ret.Add($"Interval:{DocConvert.NullGuid}");
                }
                else
                {
                    ret.Add($"Interval:{thing.Interval.GetGuid()}");
            }
        ...
        public static Guid GetGuid(DocEntityAttributeInterval thing)
        {
