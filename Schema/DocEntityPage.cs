...
namespace Services.Schema
{
    ...
    public partial class DocEntityPage : DocEntityBase
    {
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public static DocEntityPage Get(Reference reference) => (true == (reference?.Id > 0)) ? Get(reference.Id) : null;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public static DocEntityPage Get(int? primaryKey, bool noCache, DocQuery query)
        {
