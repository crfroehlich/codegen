...
namespace Services.Schema
{
    ...
    public partial class DocEntityMeanRangeValue : DocEntityBase
    {
        ...
        public DocEntityMeanRangeValue(Session session)
            : base(session) { }

        /// <summary>
        ///    Initializes a new instance of this class as a default, session-less object.
        /// </summary>
        public DocEntityMeanRangeValue()
        ...
        /// <summary>
        ///    The Model name of this class is <see cref="DocConstantModelName.MEANRANGEVALUE" />
        /// </summary>
        ...
        {
            return  (T) ((IDocModel) ToMeanRangeValue());
