...
namespace Services.Schema
{
    ...
    public partial class DocEntityLocale : DocEntityBase
    {
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityLocale Get(Reference reference) => (true == (reference?.Id > 0)) ? Get(reference.Id) : null;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityLocale Get(int? primaryKey, bool noCache, DocQuery query)
        {
