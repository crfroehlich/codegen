...
namespace Services.Schema
{
    ...
    public partial class DocEntityUnitConversionRules : DocEntityBase
    {
        ...
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityUnitConversionRules Get(Reference reference) => (true == (reference?.Id > 0)) ? Get(reference.Id) : null;
        [GeneratedCodeAttribute("T4", "1.0.0.0")]
        public new static DocEntityUnitConversionRules Get(int? primaryKey, bool noCache, DocQuery query)
        {
