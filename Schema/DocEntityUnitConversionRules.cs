...
namespace Services.Schema
{
    ...
    public partial class DocEntityUnitConversionRules : DocEntityBase
    {
        ...
        public DocEntityUnitConversionRules(Session session)
            : base(session) { }

        /// <summary>
        ///    Initializes a new instance of this class as a default, session-less object.
        /// </summary>
        public DocEntityUnitConversionRules()
        ...
        /// <summary>
        ///    The Model name of this class is <see cref="DocConstantModelName.UNITCONVERSIONRULES" />
        /// </summary>
        public static readonly DocConstantModelName MODEL_NAME = DocConstantModelName.UNITCONVERSIONRULES;
        ...
        public override bool UnlockRecord()
        {
            ...
            _OnUnlock();
            if (!ret) throw new ServiceStack.HttpError(System.Net.HttpStatusCode.Forbidden, $"You do not have permission to unlock this {nameof(UnitConversionRules)}");
            if (ret)
            {
                _isNewlyLocked = true;
                Locked = false;
        ...
        {
            _OnFlushCache();
            DocCacheClient.RemoveSearch("UnitConversionRules");
        ...
        public static Guid GetGuid(DocEntityUnitConversionRules thing)
        {
    ...
    public partial class UnitConversionRulesMapper : Profile
    {
