    ...
    public partial class UserSessionMapper : DocMapperBase
    {
        ...
        public UserSessionMapper()
        {
            ...
            _EntityToDto = CreateMap<DocEntityUserSession,UserSession>()
                ...
                .ForMember(dest => dest.ImpersonationsCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<UserSession>(c, nameof(DocEntityUserSession.ImpersonationsIds))))
                ...
                .ForMember(dest => dest.RequestsCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<UserSession>(c, nameof(DocEntityUserSession.RequestsIds))))
                ...
                .ForMember(dest => dest.UserHistoryCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<UserSession>(c, nameof(DocEntityUserSession.UserHistoryIds))))
                .MaxDepth(2);
