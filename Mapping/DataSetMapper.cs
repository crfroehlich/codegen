    ...
    public partial class DataSetMapper : DocMapperBase
    {
        ...
        public DataSetMapper()
        {
            ...
            _EntityToDto = CreateMap<DocEntityDataSet,DataSet>()
                ...
                .ForMember(dest => dest.CharacteristicsIds, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<DataSet>(c, nameof(DocEntityDataSet.CharacteristicsIds))))
                ...
                .ForMember(dest => dest.ComparatorsIds, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<DataSet>(c, nameof(DocEntityDataSet.ComparatorsIds))))
                ...
                .ForMember(dest => dest.ImportsIds, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<DataSet>(c, nameof(DocEntityDataSet.ImportsIds))))
                ...
                .ForMember(dest => dest.InterventionsIds, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<DataSet>(c, nameof(DocEntityDataSet.InterventionsIds))))
                ...
                .ForMember(dest => dest.OutcomesIds, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<DataSet>(c, nameof(DocEntityDataSet.OutcomesIds))))
                ...
                .ForMember(dest => dest.ProjectsIds, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<DataSet>(c, nameof(DocEntityDataSet.ProjectsIds))))
                ...
                .ForMember(dest => dest.StudyDesignsIds, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<DataSet>(c, nameof(DocEntityDataSet.StudyDesignsIds))))
                .MaxDepth(2);
