    ...
    public partial class VariableRuleMapper : DocMapperBase
    {
        ...
        public VariableRuleMapper()
        {
            ...
            _EntityToDto = CreateMap<DocEntityVariableRule,VariableRule>()
                ...
                .ForMember(dest => dest.ChildrenCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<VariableRule>(c, nameof(DocEntityVariableRule.ChildrenIds))))
                ...
                .ForMember(dest => dest.InstancesCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<VariableRule>(c, nameof(DocEntityVariableRule.InstancesIds))))
                ...
                .ForMember(dest => dest.ScopesCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<VariableRule>(c, nameof(DocEntityVariableRule.ScopesIds))))
