    ...
    public partial class HelpMapper : DocMapperBase
    {
        ...
        public HelpMapper()
        {
            ...
            _EntityToDto = CreateMap<DocEntityHelp,Help>()
                ...
                .ForMember(dest => dest.PagesCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<Help>(c, nameof(DocEntityHelp.PagesIds))))
                ...
                .ForMember(dest => dest.ScopesCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<Help>(c, nameof(DocEntityHelp.ScopesIds))))
