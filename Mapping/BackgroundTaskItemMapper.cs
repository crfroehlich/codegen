    ...
    public partial class BackgroundTaskItemMapper : DocMapperBase
    {
        ...
        public BackgroundTaskItemMapper()
        {
            ...
            _EntityToDto = CreateMap<DocEntityBackgroundTaskItem,BackgroundTaskItem>()
                ...
                .ForMember(dest => dest.TaskHistoryIds, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<BackgroundTaskItem>(c, nameof(DocEntityBackgroundTaskItem.TaskHistoryIds))))
                .MaxDepth(2);
