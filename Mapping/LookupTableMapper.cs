    ...
    public partial class LookupTableMapper : DocMapperBase
    {
        ...
        public LookupTableMapper()
        {
            ...
            _EntityToDto = CreateMap<DocEntityLookupTable,LookupTable>()
                ...
                .ForMember(dest => dest.BindingsIds, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<LookupTable>(c, nameof(DocEntityLookupTable.BindingsIds))))
                ...
                .ForMember(dest => dest.CategoriesIds, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<LookupTable>(c, nameof(DocEntityLookupTable.CategoriesIds))))
                ...
                .ForMember(dest => dest.DocumentsIds, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<LookupTable>(c, nameof(DocEntityLookupTable.DocumentsIds))))
