    ...
    public partial class LibrarySetMapper : DocMapperBase
    {
        ...
        public LibrarySetMapper()
        {
            ...
            _EntityToDto = CreateMap<DocEntityLibrarySet,LibrarySet>()
                ...
                .ForMember(dest => dest.CharacteristicsCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<LibrarySet>(c, nameof(DocEntityLibrarySet.CharacteristicsIds))))
                ...
                .ForMember(dest => dest.ComparatorsCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<LibrarySet>(c, nameof(DocEntityLibrarySet.ComparatorsIds))))
                ...
                .ForMember(dest => dest.InterventionsCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<LibrarySet>(c, nameof(DocEntityLibrarySet.InterventionsIds))))
                ...
                .ForMember(dest => dest.OutcomesCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<LibrarySet>(c, nameof(DocEntityLibrarySet.OutcomesIds))))
                ...
                .ForMember(dest => dest.ProjectsCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<LibrarySet>(c, nameof(DocEntityLibrarySet.ProjectsIds))))
                ...
                .ForMember(dest => dest.StudyDesignsCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<LibrarySet>(c, nameof(DocEntityLibrarySet.StudyDesignsIds))))
