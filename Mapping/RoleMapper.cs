    ...
    public partial class RoleMapper : DocMapperBase
    {
        ...
        public RoleMapper()
        {
            ...
            _EntityToDto = CreateMap<DocEntityRole,Role>()
                ...
                .ForMember(dest => dest.AppsCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<Role>(c, nameof(DocEntityRole.AppsIds))))
                ...
                .ForMember(dest => dest.FeatureSetsCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<Role>(c, nameof(DocEntityRole.FeatureSetsIds))))
                ...
                .ForMember(dest => dest.PagesCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<Role>(c, nameof(DocEntityRole.PagesIds))))
                ...
                .ForMember(dest => dest.UsersCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<Role>(c, nameof(DocEntityRole.UsersIds))))
                .MaxDepth(2);
