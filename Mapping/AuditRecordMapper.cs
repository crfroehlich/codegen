    ...
    public partial class AuditRecordMapper : DocMapperBase
    {
        ...
        public AuditRecordMapper()
        {
            ...
            _EntityToDto = CreateMap<DocEntityAuditRecord,AuditRecord>()
                ...
                .ForMember(dest => dest.DeltasCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<AuditRecord>(c, nameof(DocEntityAuditRecord.DeltasIds))))
                ...
                .ForMember(dest => dest.EventsCount, opt => opt.PreCondition(c => DocMapperConfig.ShouldBeMapped<AuditRecord>(c, nameof(DocEntityAuditRecord.EventsIds))))
